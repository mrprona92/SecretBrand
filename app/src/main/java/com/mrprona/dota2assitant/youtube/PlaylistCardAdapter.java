...
public class PlaylistCardAdapter extends RecyclerView.Adapter<PlaylistCardAdapter.ViewHolder> {
    ...
    private final ClickOnItemListener mListenerClick;
    ...
    public PlaylistCardAdapter(PlaylistVideos playlistVideos, LastItemReachedListener lastItemReachedListener, ClickOnItemListener mClickListener) {
        mPlaylistVideos = playlistVideos;
        mListener = lastItemReachedListener;
        mListenerClick =mClickListener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.mThumbnailImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(holder.mContext, BasicYoutubePlayerActivity.class);
                intent.putExtra(BasicYoutubePlayerActivity.VIDEO_ID_BUNDLE_VALUE, video.getId());
