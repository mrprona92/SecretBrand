package com.mrprona.dota2assitant.trackdota.adapter;
...
import com.mrprona.dota2assitant.trackdota.api.live.LogEvent;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (object instanceof LogEvent) {
            ...
            if ("kill".equals(logEvent.getAction())) {
                ...
                Glide.with(context).load(SteamUtils.getHeroMiniImage(hero.getDotaId())).placeholder(0).into(holder.heroIcon);
                if (item == null) {
                    Log.d("ITEMBINH", "getView() called with: position ="+ itemId);
