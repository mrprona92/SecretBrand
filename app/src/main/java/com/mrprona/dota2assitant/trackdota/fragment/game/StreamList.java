...
import com.mrprona.dota2assitant.base.fragment.UpdatableRecyclerFragmentNotBase;
...
import com.mrprona.dota2assitant.trackdota.task.TrackdotaStreamsLoadRequest;
 ...
 */
public class StreamList extends UpdatableRecyclerFragmentNotBase<Stream, StreamHolder> implements RequestListener<Stream.List>, TwitchGamesAdapter, Updatable<Pair<CoreResult, LiveGame>> {
