package com.badr.infodota.quiz.dialog;
...
import com.badr.infodota.base.dialog.DABaseDialog;
import com.badr.infodota.quiz.model.HighScore;
import com.badr.infodota.quiz.util.UltilsConnection;
...
public class SubmitHighscoreDialog extends DABaseDialog {
    ...
    public SubmitHighscoreDialog(Context context, Bundle mBundle) {
        super(context);
