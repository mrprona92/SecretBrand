...
UNION ALL SELECT '137','radianbutterflyce','weapons','5150','Radiance'
UNION ALL SELECT '139','butterfly','weapons','5725','Butterfly'
...
UNION ALL SELECT '190','veil_of_discord','caster','2240','Veil of Discord'
...
UNION ALL SELECT '244','iron_talon','common','500','Iron Talon'
UNION ALL SELECT '246','faerie_fire','consumable','75','Faerie Fire'
UNION ALL SELECT '248','dragon_lance','artifacts','1900','Dragon Lance'
UNION ALL SELECT '250','hurricane_pike','artifacts','4375','Hurricane Pike'
UNION ALL SELECT '252','bloodthorn','artifacts','7195','Bloodthorn'
UNION ALL SELECT '255','blightstone','armaments','300','Blight Stone'
UNION ALL SELECT '256','aether_lens','caster','2350','Aether Lens'
UNION ALL SELECT '258','wind_lace','arcane','250','Wind Lace'
UNION ALL SELECT '260','echo_sabre','artifacts','2650','Echo Sabre';