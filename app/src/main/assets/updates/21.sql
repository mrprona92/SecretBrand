...
UNION ALL SELECT '43','ward_sentry','consumable','100','Sentry Ward'
UNION ALL SELECT '218','ward_dispenser','consumable','165','Observer and Sentry Wards'
...
UNION ALL SELECT '209','heavens_halberd','artifacts','3750','Heaven''s Halberd'
...
UNION ALL SELECT '257','tome_of_knowledge','consumable','150','Tome Of Knowledge'
UNION ALL SELECT '265','infused_raindrop','armor','225','Infused Raindrop';